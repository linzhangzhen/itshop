			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$v): ?><li>
						<dl>
							<dt><a href="<?php echo U('detail',array('goods_id'=>$v['goods_id']));?>"><img src="<?php echo (substr($v["goods_small_logo"],1)); ?>" alt="" /></a></dt>
							...
							<dd><strong>促销价￥<?php echo ($v["goods_member_price"]); ?></strong></dt>

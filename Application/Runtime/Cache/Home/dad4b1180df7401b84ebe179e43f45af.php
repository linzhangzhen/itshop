...
<div class="mycart w990 mt10 bc">
    ...
    <table>
            ...
            <tbody>
            <tr>
                <td class="col2"> <p>订单ID</p> <p><?php echo ($orderinfo['order_number']); ?></p> </td>
                <td class="col2"> <p>订单价格</p> <p><?php echo ($orderinfo['order_price']); ?></p> </td>
                <td class="col2"> <p>是否付款</p> <p><?php echo ($orderinfo['order_status'] == '0'?'<span style="font-weight: bold;color:red">未付款</span>':'<span style="font-weight: bold;color:green">已付款</span>'); ?></p> </td>
                <td class="col2"> <p>是否发货</p> <p><?php echo ($orderinfo['is_send'] == '是'?'<span style="font-weight: bold;color:green">已发货</span>':'<span style="font-weight: bold;color:red">未发货</span>'); ?></p> </td>
            </tr>
            <tr>
                <td class="col2"> <p>购买时间</p> <p><?php echo (date('Y-m-d H:i:s',$orderinfo['add_time'])); ?></p> </td>
                <td class="col2"> <p>订单价格</p> <p><?php echo ($orderinfo['order_price']); ?></p> </td>
                <td class="col2"> <p>支付方式</p> <p><?php echo ($orderinfo['order_pay']); ?></p> </td>

            </tr>
            <?php if(is_array($goodsinfo)): foreach($goodsinfo as $k=>$v): ?><tr>
                    <td class="col1"><img src="<?php echo (substr($v['goods_small_logo'],1)); ?>" alt="暂无图片" />  <strong><?php echo ($v['goods_name']); ?></strong></td>
                    <td class="col2"> <p>商品价格</p> <p><?php echo ($v['goods_price']); ?></p> </td>
                    <td class="col2"> <p>购买数量</p> <p><?php echo ($v['goods_number']); ?></p> </td>
                    <td class="col2"> <p>小计价格</p> <p><?php echo ($v['goods_total_price']); ?></p> </td>
                </tr>
                <tr>
                    <td class="col2"> <p>商品简介</p> <p><?php echo ($v['goods_introduce']); ?></p> </td>

        ...
        <div class="summary">
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="shop_price"><span>本店价：</span > <strong id="price_ynamic" >￥<?php echo ($goodsinfo['goods_member_price']); ?></strong> <a href="">(降价通知)</a></li>
                       ...
                       <!--     <?php if(is_array($manyinfo)): foreach($manyinfo as $key=>$v): ?><li class="product">
                        ...
                        <li>
                            <dl>
                                <dt>&nbsp;</dt>
                                <dd>
                                    <input type="button"  id="add_btn" class="add_btn"  onclick="add_cart(<?php echo ($goodsinfo["goods_id"]); ?>)"/>
                                </dd>
                            </dl>
                        </li>
...
<script type="text/javascript">
    ...
    $(function () {
        //首先要获取商品的id
        layer.msg('开始！');
        var goods_id = $('#get_goods_id').text();

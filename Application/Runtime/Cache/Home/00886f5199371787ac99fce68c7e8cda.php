...
<div class="list w1210 bc mt10">
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                <?php if(is_array($miaoshainfo)): foreach($miaoshainfo as $key=>$v): ?><li>
                        <dl>
                            <dt><a href="<?php echo U('miaoshadetail',array('miaosha_id'=>$v['miaosha_id']));?>"><img src="<?php echo (substr($v["goods_small_logo"],1)); ?>" alt="" /></a></dt>
                            <dd><a href="<?php echo U('miaoshadetail',array('miaosha_id'=>$v['miaosha_id']));?>"><?php echo ($v["goods_name"]); ?></a></dt>
                            <dd><strong>￥<?php echo ($v["goods_price"]); ?></strong></dt>
                            <dd><strong style="color: #0c7edf"><?php echo (date('m-d H:i',$v["start_time"])); ?></strong></dt>
                            <dd><strong >离开始还有
                                <div class="time-item">
                            ...
                            <dd><strong style="color: green">秒杀数量<?php echo ($v["goods_number"]); ?></strong></dt>
                        </dl>

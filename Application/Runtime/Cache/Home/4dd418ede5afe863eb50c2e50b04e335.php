		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select ">
					<ul>
						<li class="cur">
							<input type="radio" name="cgn_id" checked="checked" value="32" />王超平 北京市 昌平区 建材城西路金燕龙办公楼一层 13555555555
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
						<li>
							<input type="radio" name="cgn_id"  value="35" />王超平 湖北省 武汉市  武昌 关山光谷软件园1号201 13333333333
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
			...
			<div class="pay">
				...
				<div class="pay_select none">
					<table> 
						<tr class="cur">
							<td class="col1"><input type="radio" name="order_pay" checked="checked"  value="0"/>支付宝</td>
			...
			<div class="receipt">
				...
				<div class="receipt_select none">
						...
						<ul>
							...
							<li>
								<label for="">发票公司：</label>
								<input type="radio"   class="company" />
								<input type="text" class="txt order_fapiao_company"name="order_fapiao_company"  />
							</li>
							<li>

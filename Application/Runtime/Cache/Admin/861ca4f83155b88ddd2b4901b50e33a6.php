                    ...
                    <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="94%" valign="bottom"><span class="STYLE1"> 会员管理 -> 会员级别修改</span></td>
                            </tr>
                        </table></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                    <tr>
                        <td colspan='100'  bgcolor="#FFFFFF"  class="STYLE6" style="text-align:center;">
                            <input type="button" id="sub_mit" value="修改会员等级">
                        </td>
                    </tr>
                </table>
            </form>
    ...
    $(function () {
        $('#sub_mit').click(function () {
            ...
            $.ajax({
                ...
                url:'/index.php/Admin/Member/updlevel',
                data:data,
                type:'post',
                dataType:'json',
                success:function (msg) {
                    ...
                    if(msg.status == 0){
                        ...
                        //失败 就刷新当前页面
                        layer.msg(msg.tips);
                        window.location.href = ('/index.php/Admin/Member/updlevel?id='+$('#level_id').val());
                    }
                }
            })
        })

    ...
    <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
            <tr>
                ...
                <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">权限ac</span></div></td>
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                    ...
                    <td id="role_id" height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["role_id"]); ?></div></td>
                    ...
                    <td height="20" bgcolor="#FFFFFF">
                        <div align="center">
                            <span class="STYLE21">
                        <a href="<?php echo U('distribute',array('role_id'=>$v['role_id']));?>" style="color:rgb(58,99,117);" >分配权限</a>
                        <a id="del_role" href="#" style="color:rgb(58,99,117);" ><img src="<?php echo C('AD_IMG_URL');?>del.gif" width="10" height="10" /> 删除</a> |
                        查看 | <img src="<?php echo C('AD_IMG_URL');?>edit.gif" width="10" height="10" /> <a
                                    href="<?php echo U('upd',array('role_id'=>$v['role_id']));?>" style="color:rgb(58,99,117);">编辑</a></span></div></td>
    ...
    $(function () {
        ...
        $('[id$=del_role]').click(function () {
            ...
            $.ajax({
                ...
                url:'/index.php/Admin/Role/delRole',

    ...
    <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
            <tr>
                ...
                <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">级别ID</span></div></td>
                <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="left"><span class="STYLE10">级别名</span></div></td>
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                    ...
                    <td height="20" id="auth_id"  bgcolor="#FFFFFF" class="STYLE19"><div align="center"><span><?php echo ($v["id"]); ?></span></div></td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><?php echo ($v["level_name"]); ?></div></td>
                    ...
                    <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
                        ...
                        查看 |
                        <a  href="<?php echo U('updlevel',array('id'=>$v['id']));?>" style="color:rgb(58,99,117);"> <img src="<?php echo C('AD_IMG_URL');?>edit.gif" width="10" height="10" />编辑</a></div></td>
        ...
        $('[id$=delete_auth]').click(function () {
            ...
            layer.confirm('真的要删除吗', {
                ...
                $.ajax({
                    ...
                    url:'/index.php/Admin/Member/delete',

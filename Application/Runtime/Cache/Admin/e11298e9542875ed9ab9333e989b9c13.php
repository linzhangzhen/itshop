...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <a href="/index.php/Admin/Auth/showlist">返回</a>   &nbsp; </span>
    ...
    $(function () {
        $('#sub_mit').click(function () {
            ...
            $.ajax({
                ...
                url:'/index.php/Admin/Auth/ajaxAdd',
                data:data,
                type:'get',
                dataType:'json',
                success:function (msg) {
                    ...
                    if(msg.states === 0){
                        ...
                        layer.confirm('新增成功，是否继续添加', {
                            ...
                            window.location.href = ('/index.php/Admin/Auth/tianjia');
                        }, function(){
                            window.location.href = ('/index.php/Admin/Auth/showlist');
                        });
                    }else{
                        //失败 就刷新当前页面
                        layer.msg(msg.tip);
